...
export class PlayersController {
  ...
  @Get()
  @ApiOperation({ summary: 'Obtém a lista atual de jogadores com indicação de convidados.' })
  ...
  @ApiResponse({ status: 200, description: 'Markdown contendo a lista de jogadores.' })
  export() {
